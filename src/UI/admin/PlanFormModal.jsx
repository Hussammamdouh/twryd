            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-blue-100 text-sm">
                  {isEdit ? 'Update plan details and settings' : 'Configure a new subscription plan'}
                </p>
              </div>
            </div>
            <button
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700 p-6 rounded-xl border border-gray-200 dark:border-gray-600 shadow-sm">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Plan Configuration</h3>
              </div>
            ...
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700 p-6 rounded-xl border border-gray-200 dark:border-gray-600 shadow-sm">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Plan Settings</h3>
              </div>
