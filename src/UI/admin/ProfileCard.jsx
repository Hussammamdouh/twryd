    ...
    <div className="theme-card p-4 sm:p-8 flex flex-col gap-4 sm:gap-6 max-w-xs sm:max-w-md w-full mx-auto">
          ...
          {role && (
            <div className="text-xs text-primary-500 font-semibold mb-1 px-2 py-1 bg-primary-50 rounded-full dark:bg-primary-900/30 dark:text-primary-300">
              {role === 'admin' ? 'Administrator' : 
               ...
               role === 'it_support' ? 'IT Support' : role}
            </div>
          )}
        </div>
      </div>
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between text-sm">
          ...
          <span className="font-semibold text-theme-text">Administrator</span>
        </div>
        <div className="flex items-center justify-between text-sm">
      ...
      <div className="space-y-2 pt-2">
        <button
          ...
          className="w-full px-4 sm:px-6 py-2 bg-gradient-to-r from-red-500 to-red-700 hover:from-red-600 hover:to-red-800 text-white font-bold rounded-lg shadow-lg transition-all duration-200 text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-red-400 focus:ring-offset-2 transform hover:scale-105"
      ...
      {/* Security Notice */}
      <div className="text-xs text-theme-text-muted text-center pt-2 border-t border-theme-border">
