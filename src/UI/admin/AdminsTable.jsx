  ...
  return (
    <div className="w-full max-w-7xl mx-auto py-4 sm:py-8 px-1 sm:px-2 md:px-0">
      <h1 className="text-2xl sm:text-3xl font-extrabold mb-4 sm:mb-8 text-primary-700 flex items-center gap-2 drop-shadow-sm">
        <span className="inline-block bg-primary-100 text-primary-600 rounded-full px-2 sm:px-3 py-1 text-base sm:text-lg shadow">{t('nav.administrators')}</span>
      ...
      <div className="theme-card p-4 mb-6">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          >
            <span className="inline-block align-middle mr-2">+</span> {t('administrators.add')}
          </button>
        </div>
      </div>
          ...
          <table className="min-w-full text-sm">
            <thead className="sticky top-0 z-10">
              <tr className="bg-gray-50 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                ...
                <th className="px-4 py-3 text-left text-xs font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wider">{t('administrators.role')}</th>
                ...
                <tr>
                  <td colSpan={6} className="text-center py-12">
                    <div className="flex flex-col items-center gap-3">
                      ...
                      <span className="text-gray-500 dark:text-gray-400">{t('administrators.loading')}</span>
                    </div>
                  </td>
                </tr>
              ) : admins.length === 0 ? (
                <tr>
                  <td colSpan={6} className="text-center py-12">
                    <div className="flex flex-col items-center gap-3">
                      ...
                      <div className="text-lg font-semibold text-gray-500 dark:text-gray-400">{t('administrators.no_administrators')}</div>
                      <p className="text-gray-400 dark:text-gray-500">{t('administrators.get_started')}</p>
                      <button
                        onClick={handleAdd}
