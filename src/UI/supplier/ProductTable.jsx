    ...
    return (
      <div className="flex justify-center py-8 sm:py-12 text-theme-text-secondary">
        <div className="text-center">
          <div className="text-lg font-medium mb-2">{t('products.loading_products')}</div>
        </div>
      </div>
    );
  }
  ...
  if (!products || products.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-8 sm:py-12 text-theme-text-muted gap-4 px-4">
        <div className="text-center">
          <div className="text-lg sm:text-xl font-medium mb-2">{t('products.no_products_found')}</div>
          <p className="text-sm text-theme-text-secondary mb-4">{t('products.no_products_message')}</p>
        </div>
      </div>
    );
  }
        ...
        <table className="min-w-full text-sm bg-white dark:bg-gray-900" role="table" aria-label="Products Table">
          <thead>
            <tr className="bg-gray-50 dark:bg-gray-800 text-gray-700 dark:text-gray-200" role="row">
              <th className="px-4 md:px-6 py-3 text-left font-semibold border-b border-gray-200 dark:border-gray-700" role="columnheader">{t('products.product_name')}</th>
              ...
              <th className="px-4 md:px-6 py-3 text-left font-semibold border-b border-gray-200 dark:border-gray-700" role="columnheader">{t('products.category')}</th>
              <th className="px-4 md:px-6 py-3 text-left font-semibold border-b border-gray-200 dark:border-gray-700" role="columnheader">{t('products.price')}</th>
              <th className="px-4 md:px-6 py-3 text-left font-semibold border-b border-gray-200 dark:border-gray-700" role="columnheader">{t('products.discount')}</th>
              <th className="px-4 md:px-6 py-3 text-left font-semibold border-b border-gray-200 dark:border-gray-700" role="columnheader">{t('products.status')}</th>
              <th className="px-4 md:px-6 py-3 text-left font-semibold border-b border-gray-200 dark:border-gray-700" role="columnheader">{t('products.actions')}</th>
            </tr>
          </thead>
              ...
              >
                ...
                <td className="px-4 md:px-6 py-4 whitespace-nowrap">
                  <span className={`px-3 py-1 rounded-full text-xs font-semibold ${product.is_active ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300' : 'bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300'}`}
                    aria-label={product.is_active ? t('products.active') : t('products.inactive')}>{product.is_active ? t('products.active') : t('products.inactive')}</span>
                </td>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start justify-between gap-3">
                <div className="flex-1">
                  <div className="text-xs font-medium text-theme-text-secondary mb-1">{t('products.product_name')}</div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <div className="text-xs font-medium text-theme-text-secondary mb-1">{t('products.category')}</div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <div className="text-xs font-medium text-theme-text-secondary mb-1">{t('products.price')}</div>
                  <div className="text-sm font-medium text-theme-text">${parseFloat(product.price || 0).toFixed(2)}</div>
                </div>
                <div>
                  <div className="text-xs font-medium text-theme-text-secondary mb-1">{t('products.discount')}</div>
              ...
              <div className="pt-3 border-t border-theme-border">
                <div className="text-xs font-medium text-theme-text-secondary mb-2">{t('products.actions')}</div>
