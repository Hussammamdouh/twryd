...
export default function SubscriptionsTableHeader({
  data,
  totalData,
  searchTerm,
  setSearchTerm,
  ...
  const statusOptions = [
    { value: 'all', label: t('subscriptions.all_subscriptions') },
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 lg:gap-6">
        ...
        <div className="flex items-center justify-between lg:justify-end gap-4">
          <div className="hidden lg:flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
            ...
            <span>{t('subscriptions.showing', { from: data.length, to: data.length, total: totalData.length })}</span>
          </div>
