      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl border border-gray-100 p-8 sm:p-10 flex flex-col items-center">
        ...
        <form onSubmit={handleSubmit} className="w-full flex flex-col gap-7" aria-busy={loading}>
          ...
          <div className="flex justify-between text-sm mt-4">
            <Link to="/forgot-password-supplier" className="text-blue-600 hover:underline">Forgot Password?</Link>
            <Link to="/register-supplier" className="text-blue-600 hover:underline">Register</Link>
          </div>
          <button
            type="submit"
            disabled={loading}
